...
//+kubebuilder:rbac:groups=secrets-store.csi.x-k8s.io.secrets-store.csi.x-k8s.io,resources=secretproviders,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=secrets-store.csi.x-k8s.io.secrets-store.csi.x-k8s.io,resources=secretproviders/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=secrets-store.csi.x-k8s.io.secrets-store.csi.x-k8s.io,resources=secretproviders/finalizers,verbs=update
